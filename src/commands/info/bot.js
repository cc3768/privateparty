...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        switch (subCommand) {
            ...
            case 'author': {
                const authorDescription = `Hey there, I'm **PrivateParty**! My developer/creator is **Vicii**. My goal is to liven up your server by bringing entertainment and good vibes, always ready to brighten your day ${emojis.love}`;
                const discordUserUrl = `https://discord.com/users/181124932439113728`;
                const botAvatarUrl = client.user.displayAvatarURL({ dynamic: true, size: 1024 });
